...
const LOCALES = {
  en: {
    ...
    load_earlier_hidden: 'Load earlier ({n} hidden)',
    scroll_up_load_more: '↑ Scroll up to load more',
    click_load_earlier: 'Click to load earlier messages',
  ...
  zh: {
    ...
    load_earlier_hidden: '加载更早消息（还有 {n} 条）',
    scroll_up_load_more: '↑ 继续向上滚动加载更多',
    click_load_earlier: '点击加载更早的消息',
  ...
  'zh-Hant': {
    ...
    load_earlier_hidden: '載入較早訊息（還有 {n} 條）',
    scroll_up_load_more: '↑ 繼續向上捲動載入更多',
    click_load_earlier: '點擊載入較早的訊息',
